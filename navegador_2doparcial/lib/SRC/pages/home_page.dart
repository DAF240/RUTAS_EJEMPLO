import 'package:navegador_2doparcial/src/providers/menu_provider.dart';
import 'package:navegador_2doparcial/src/utils/icono_string_util.dart';
...
class HomePage extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(
        title: Text('*BIENVENIDA A LA NAVEGACION*'),
